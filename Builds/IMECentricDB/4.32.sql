...
BEGIN TRANSACTION
GO
PRINT N'Altering [dbo].[tblDoctorSpecialty_AfterInsert_TRG]...';


GO

ALTER TRIGGER tblDoctorSpecialty_AfterInsert_TRG 
...
GO
PRINT N'Altering [dbo].[tblDoctorSpecialty_BeforeDelete_TRG]...';


GO

ALTER TRIGGER tblDoctorSpecialty_BeforeDelete_TRG 
  ON tblDoctorSpecialty
FOR DELETE
AS
BEGIN
