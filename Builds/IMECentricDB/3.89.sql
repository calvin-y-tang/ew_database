...
BEGIN TRANSACTION
GO
PRINT N'Dropping [dbo].[DF_tblQuoteRule_EWSelected]...';


GO
ALTER TABLE [dbo].[tblQuoteRule] DROP CONSTRAINT [DF_tblQuoteRule_EWSelected];
...
GO
PRINT N'Dropping [dbo].[DF_tblQuoteRule_InNetwork]...';


GO
ALTER TABLE [dbo].[tblQuoteRule] DROP CONSTRAINT [DF_tblQuoteRule_InNetwork];
...
ALTER TABLE [dbo].[tblCaseAppt]
    ADD [DoctorReason] VARCHAR (25) NULL;
...
ALTER TABLE [dbo].[tblEWParentCompany]
    ADD [RequireOutofNetworkReason] BIT CONSTRAINT [DF_tblEWParentCompany_RequireOutofNetworkReason] DEFAULT (0) NULL;
...
GO
ALTER TABLE [dbo].[tblQuoteRule] ALTER COLUMN [EWSelected] INT NULL;

ALTER TABLE [dbo].[tblQuoteRule] ALTER COLUMN [InNetwork] INT NULL;
...
GO
PRINT N'Creating [dbo].[DF_tblQuoteRule_EWSelected]...';


GO
ALTER TABLE [dbo].[tblQuoteRule]
    ADD CONSTRAINT [DF_tblQuoteRule_EWSelected] DEFAULT ((2)) FOR [EWSelected];
...
GO
PRINT N'Creating [dbo].[DF_tblQuoteRule_InNetwork]...';


GO
ALTER TABLE [dbo].[tblQuoteRule]
    ADD CONSTRAINT [DF_tblQuoteRule_InNetwork] DEFAULT ((2)) FOR [InNetwork];
