...
ALTER TABLE [dbo].[tblCase]
    ADD [AllowMigratingClaim] BIT NULL;
...
ALTER TABLE [dbo].[tblControl]
    ADD [AllowMigratingClaim] BIT CONSTRAINT [DF_tblControl_AllowMigratingClaim] DEFAULT ((0)) NOT NULL;
...
UPDATE tblControl SET DBVersion='2.91'
GO