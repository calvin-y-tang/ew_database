...
ALTER TABLE [dbo].[tblCase]
    ADD [TATExamDateToNotifyShowNoShow] INT NULL;
...
ALTER TABLE [dbo].[tblCaseAppt]
    ADD [DateShowNoShowLetterSent] DATETIME NULL;
...
ALTER TABLE [dbo].[tblEWParentCompany]
    ADD [RequireInOutNetworkInvoice] BIT CONSTRAINT [DF_tblEWParentCompany_RequireInOutNetworkInvoice] DEFAULT ((0)) NULL;
...
GO
PRINT N'Altering [dbo].[tblParamProperty]...';


GO
ALTER TABLE [dbo].[tblParamProperty]
    ADD [Visible] BIT CONSTRAINT [DF_tblParamProperty_Visible] DEFAULT ((1)) NULL;
...
ALTER TABLE [dbo].[tblWebUser]
    ADD [LanguageIDPreference] INT CONSTRAINT [DF_tblWebUser_LanguageIDPreference] DEFAULT ((110)) NULL;
