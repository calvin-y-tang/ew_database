...
GO
PRINT N'Creating [dbo].[tblAcctQuote].[IX_tblAcctQuote_CaseDocID]...';


GO
CREATE NONCLUSTERED INDEX [IX_tblAcctQuote_CaseDocID]
    ON [dbo].[tblAcctQuote]([CaseDocID] ASC);
...
GO
PRINT N'Creating [dbo].[fnGetBusinessHours]...';
...
INSERT INTO tblBusinessRule (BusinessRuleID, Name, Category, Descrip, IsActive, EventID, AllowOverride, Param1Desc, Param2Desc, Param3Desc, Param4Desc, Param5Desc, BrokenRuleAction)
VALUES (154, 'AutoResendQuoteDoc', 'Case', 'Determine the Resent Date for Quote Document.', 1, 1201, 0, 'NbrHrsAddToOrigDate', NULL, NULL, NULL, NULL, 0)
GO
INSERT INTO tblBusinessRuleCondition(BusinessRuleID, EntityType, EntityID, BillingEntity, ProcessOrder, DateAdded, UserIDAdded, DateEdited, UserIDEdited, OfficeCode, EWBusLineID, EWServiceTypeID, Jurisdiction, Param1, Param2, Param3, Param4, Param5)
VALUES(154, 'PC', 4, 2, 1, GETDATE(), 'Admin', GETDATE(), 'Admin', NULL, NULL, 1, NULL, '16', NULL, NULL, NULL, NULL), 
      (154, 'PC', 4, 2, 1, GETDATE(), 'Admin', GETDATE(), 'Admin', NULL, NULL, 2, NULL, '16', NULL, NULL, NULL, NULL), 
      (154, 'PC', 4, 2, 1, GETDATE(), 'Admin', GETDATE(), 'Admin', NULL, NULL, 3, NULL, '16', NULL, NULL, NULL, NULL)
GO
