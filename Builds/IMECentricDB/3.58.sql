...
ALTER TABLE [dbo].[tblCase]
    ADD [TATDateLossToApptDate]            INT NULL,
...
GO
PRINT N'Altering [dbo].[tblStorage]...';


GO
ALTER TABLE [dbo].[tblStorage]
    ADD [DateReadyDelete] DATETIME NULL,
...
GO
PRINT N'Creating [dbo].[tblStorageRetentionRule]...';
...
GO
PRINT N'Creating [dbo].[proc_GetReferralHistoryByClaimAndCompany]...';
