...
ALTER TABLE [dbo].[tblCase]
    ADD [DateEmailSentForLateReport] DATETIME NULL;
...
VALUES (134, 'SW', NULL, 2, 2, GETDATE(), 'Admin', GETDATE(), 'Admin', NULL, 3, NULL, 'CA', 'AME', 'DEU-;DEU -', 'Client;Plaintiff;Defense;ThirdParty', 'Client;Plaintiff;Examinee;Defense;ThirdParty', NULL, 0, NULL),
       ...
       (134, 'SW', NULL, 2, 2, GETDATE(), 'Admin', GETDATE(), 'Admin', NULL, 3, NULL, 'CA', 'P/U-QME', 'DEU-;DEU -', 'Client;Examinee;Defense', 'Client;Examinee;Plaintiff;Defense', NULL, 0, NULL),
