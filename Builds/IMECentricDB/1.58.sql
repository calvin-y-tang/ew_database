...
---------------------------------------
--Increase the size of tblClaimInfo
---------------------------------------
ALTER TABLE [tblClaimInfo]
  ALTER COLUMN [DoctorNonNPINbr] VARCHAR(50)
GO
...
-----------------------------------------------
--National Portal changes by Gary
-----------------------------------------------




ALTER PROCEDURE [dbo].[proc_WebUser_Insert]
(
...
ALTER PROCEDURE [dbo].[proc_WebUser_Update]
(
	@WebUserID int,
	@UserID varchar(100) = NULL,
	@Password varchar(200) = NULL,
...
CREATE PROCEDURE [dbo].[proc_CaseHistory_LoadByWebUserIDAndLastLoginDate]
...
SELECT DISTINCT tblCaseHistory.*, claimnbr, tblExaminee.firstname + ' ' + tblExaminee.lastname AS examineename 
	...
	WHERE tblCaseHistory.dateadded > @LastLoginDate
GO
...
CREATE PROCEDURE [dbo].[proc_GetSuperUserAvailUserListItemsNew]
...
ALTER PROCEDURE [dbo].[proc_GetCaseDetails] 
...
ALTER PROCEDURE [dbo].[proc_GetReferralSearch]
...
CREATE PROCEDURE [dbo].[proc_GetReferralSummaryByWebStatusDesc]

@WebStatusDesc varchar(50),
@WebUserID int
...
BEGIN
	...
	SELECT DISTINCT TOP 100 PERCENT 
		...
		WHERE (tblWebQueues.description = @WebStatusDesc)
		AND (tblCase.status <> 0)
...
CREATE PROCEDURE [dbo].[proc_CaseDocuments_LoadByWebUserIDAndLastLoginDate] 
...
update tblControl set DBVersion='1.58'
GO
