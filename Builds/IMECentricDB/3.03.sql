...
ALTER TABLE [dbo].[tblCase]
    ADD [TATExamToClientNotified]    INT NULL,
        ...
        [TATRptRecievedToQAComplete] INT NULL,
...
ALTER TABLE [dbo].[tblCaseAppt]
    ADD [DateClientNotified] DATETIME NULL;
...
ALTER TABLE [dbo].[tblLocation]
    ADD [AddressInstructions] VARCHAR (250) NULL;


GO
PRINT N'Creating [dbo].[tblCaseSLARuleDetail]...';
...
GO
PRINT N'Creating [dbo].[tblDataField]...';
...
CREATE TABLE [dbo].[tblDataField] (
    ...
    CONSTRAINT [PK_tblTATField] PRIMARY KEY CLUSTERED ([DataFieldID] ASC)
);


GO
PRINT N'Creating [dbo].[tblSLARule]...';
...
GO
PRINT N'Creating [dbo].[tblSLARuleCondition]...';
...
GO
PRINT N'Creating [dbo].[tblSLARuleDetail]...';
...
GO
PRINT N'Creating [dbo].[tblTATCalculationGroup]...';


GO
CREATE TABLE [dbo].[tblTATCalculationGroup] (
    [TATCalculationGroupID] INT          NOT NULL,
    [Name]                  VARCHAR (30) NULL,
    CONSTRAINT [PK_tblTATCalculationGroup] PRIMARY KEY CLUSTERED ([TATCalculationGroupID] ASC)
);


GO
PRINT N'Creating [dbo].[tblTATCalculationGroupDetail]...';
...
GO
PRINT N'Creating [dbo].[tblTATCalculationMethod]...';
...
CREATE TABLE [dbo].[tblTATCalculationMethod] (
    ...
    [UseTrend]               BIT         NOT NULL,
    CONSTRAINT [PK_tblTATCalculationMethod] PRIMARY KEY CLUSTERED ([TATCalculationMethodID] ASC)
);


GO
PRINT N'Creating [dbo].[DF_tblCaseSLARuleDetail_DateAdded]...';


GO
ALTER TABLE [dbo].[tblCaseSLARuleDetail]
    ADD CONSTRAINT [DF_tblCaseSLARuleDetail_DateAdded] DEFAULT (getdate()) FOR [DateAdded];


GO
PRINT N'Creating [dbo].[DF_tblCaseSLARuleDetail_Fullfilled]...';


GO
ALTER TABLE [dbo].[tblCaseSLARuleDetail]
    ADD CONSTRAINT [DF_tblCaseSLARuleDetail_Fullfilled] DEFAULT ((0)) FOR [Fullfilled];


GO
PRINT N'Creating [dbo].[DF_tblSLARule_Active]...';


GO
ALTER TABLE [dbo].[tblSLARule]
    ADD CONSTRAINT [DF_tblSLARule_Active] DEFAULT ((1)) FOR [Active];


GO
PRINT N'Creating [dbo].[DF_tblTATCalculationMethod_UseTrend]...';


GO
ALTER TABLE [dbo].[tblTATCalculationMethod]
    ADD CONSTRAINT [DF_tblTATCalculationMethod_UseTrend] DEFAULT ((0)) FOR [UseTrend];
...
INSERT INTO tblMessageToken ([Name]) VALUES ('@LocationAddressInstructions@')
GO

INSERT INTO tblUserFunction VALUES ('SLARuleAddEdit','SLA Rule - Add/Edit')
GO


UPDATE tblCaseAppt SET DateClientNotified=LastStatusChg WHERE ApptStatusID NOT IN (0,10) AND DateClientNotified IS NULL
GO



INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (101, 'tblCase', 'TATEnteredToMRRReceived', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (102, 'tblCase', 'TATRptReceivedToQAComplete', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (103, 'tblCase', 'TATQACompleteToRptSent', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (104, 'tblCase', 'TATRptSentToInvoiced', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (105, 'tblCase', 'TATReport', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (106, 'tblCase', 'TATServiceLifeCycle', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (107, 'tblCase', 'TATEnteredToScheduled', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (108, 'tblCase', 'TATScheduledToExam', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (109, 'tblCase', 'TATExamToClientNotified', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (110, 'tblCase', 'TATExamToRptReceived', '')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (201, 'tblCase', 'DateReceived', 'Referral Entered into IMEC')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (202, 'tblCase', 'DateMedsRecd', 'Records Received')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (203, 'tblCase', 'RptInitialDraftDate', 'Report Received by QA')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (204, 'tblCase', 'RptFinalizedDate', 'QA Completed')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (205, 'tblCase', 'RptSentDate', 'Report Sent to Client')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (206, 'tblCase', 'InvoiceDate', 'Invoiced')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (207, 'tblCaseAppt', 'DateAdded', 'Exam Scheduled')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (208, 'tblCase', 'ApptDate', 'Date of Exam')
INSERT INTO [dbo].[tblDataField] ([DataFieldID], [TableName], [FieldName], [Descrip]) VALUES (209, 'tblCaseAppt', 'DateClientNotified', 'Client Notified')
GO

INSERT INTO [dbo].[tblTATCalculationGroup] ([TATCalculationGroupID], [Name]) VALUES (1, 'IME')
INSERT INTO [dbo].[tblTATCalculationGroup] ([TATCalculationGroupID], [Name]) VALUES (2, 'MRR')
INSERT INTO [dbo].[tblTATCalculationGroup] ([TATCalculationGroupID], [Name]) VALUES (3, 'Addendum')
GO

INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 2, 5)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 3, 6)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 4, 7)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 5, 9)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 7, 1)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 8, 2)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 9, 8)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 10, 4)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (1, 11, 3)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (2, 1, 1)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (2, 2, 2)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (2, 3, 3)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (2, 4, 4)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (2, 5, 6)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (2, 6, 5)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (3, 1, 1)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (3, 2, 2)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (3, 3, 3)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (3, 4, 4)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (3, 5, 6)
INSERT INTO [dbo].[tblTATCalculationGroupDetail] ([TATCalculationGroupID], [TATCalculationMethodID], [DisplayOrder]) VALUES (3, 6, 5)
GO
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (1, 201, 202, 'Day', 101, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (2, 203, 204, 'Day', 102, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (3, 204, 205, 'Day', 103, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (4, 205, 206, 'Day', 104, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (5, 201, 205, 'Day', 106, 1)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (6, 202, 205, 'Day', 105, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (7, 201, 207, 'Hour', 107, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (8, 207, 208, 'Day', 108, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (9, 208, 205, 'Day', 105, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (10, 208, 203, 'Day', 110, 0)
INSERT INTO [dbo].[tblTATCalculationMethod] ([TATCalculationMethodID], [StartDateFieldID], [EndDateFieldID], [Unit], [TATDataFieldID], [UseTrend]) VALUES (11, 208, 209, 'Day', 109, 0)
GO


UPDATE tblControl SET DBVersion='3.03'
GO
