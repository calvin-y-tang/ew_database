...
GO
ALTER TABLE [dbo].[tblControl] ALTER COLUMN [Dir7zip] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirDicomExtractor] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirDirections] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirIcon] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirIMECentricHelper] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirTemplate] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirVoicePlayer] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [DirWebQuickReferralFiles] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblControl] ALTER COLUMN [SourceDirectory] VARCHAR (256) NULL;
...
GO
ALTER TABLE [dbo].[tblDoctorDocuments] ALTER COLUMN [OriginalFilePath] VARCHAR (256) NULL;
...
GO
ALTER TABLE [dbo].[tblEWFacility] ALTER COLUMN [Logo] VARCHAR (256) NULL;
...
GO
ALTER TABLE [dbo].[tblIMEData] ALTER COLUMN [DirAcctDocument] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblIMEData] ALTER COLUMN [DirDocument] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblIMEData] ALTER COLUMN [DirImport] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblIMEData] ALTER COLUMN [DirTranscription] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblIMEData] ALTER COLUMN [SourceDirectory] VARCHAR (256) NULL;
...
GO
ALTER TABLE [dbo].[tblTempData] ALTER COLUMN [VarCharValue1] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblTempData] ALTER COLUMN [VarCharValue2] VARCHAR (256) NULL;

ALTER TABLE [dbo].[tblTempData] ALTER COLUMN [VarCharValue3] VARCHAR (256) NULL;
...
GO
ALTER TABLE [dbo].[tblUser] ALTER COLUMN [DefaultDymoPrinter] VARCHAR (256) NULL;
...
GO
PRINT N'Altering [dbo].[vwPDFInvDetData1]...';


GO
ALTER VIEW vwPDFInvDetData1
AS
	SELECT	
			...
			ISNULL(AD1.ToDate, AD1.Date) AS InvServiceDateTo1,
			...
			ISNULL(AD2.ToDate, AD2.Date) AS InvServiceDateTo2,
			...
			ISNULL(AD3.ToDate, AD3.Date) AS InvServiceDateTo3,
			...
			ISNULL(AD4.ToDate, AD4.Date) AS InvServiceDateTo4,
			...
			ISNULL(AD5.ToDate, AD5.Date) AS InvServiceDateTo5,
			...
			ISNULL(AD6.ToDate, AD6.Date) AS InvServiceDateTo6,
...
GO
PRINT N'Altering [dbo].[vwPDFInvDetData2]...';


GO
ALTER VIEW vwPDFInvDetData2
AS
	SELECT	
...
GO
PRINT N'Altering [dbo].[vwPDFInvDetData3]...';


GO
ALTER VIEW vwPDFInvDetData3
AS
	SELECT	
			...
			ISNULL(AD13.ToDate, AD13.Date) AS InvServiceDateTo13,
			...
			ISNULL(AD14.ToDate, AD14.Date) AS InvServiceDateTo14,
			...
			ISNULL(AD15.ToDate, AD15.Date) AS InvServiceDateTo15,
			...
			ISNULL(AD16.ToDate, AD16.Date) AS InvServiceDateTo16,
			...
			ISNULL(AD17.ToDate, AD17.Date) AS InvServiceDateTo17,
			...
			ISNULL(AD18.ToDate, AD18.Date) AS InvServiceDateTo18,
