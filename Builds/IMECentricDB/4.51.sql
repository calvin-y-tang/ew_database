...
BEGIN TRANSACTION
GO
PRINT N'Creating [dbo].[tblTranscriptionist]...';
...
GO
PRINT N'Creating [dbo].[tblTranscriptionist].[IX_tblTranscriptionist_Email]...';
...
GO
PRINT N'Creating [dbo].[tblTranscriptionist].[IX_tblTranscriptionist_WebUserID]...';
...
GO
PRINT N'Creating [dbo].[tblTranscriptionist].[IX_tblTranscriptionist_TranscriptionistID]...';
...
GO
PRINT N'Creating [dbo].[tblTranscriptionist].[IX_tblTranscriptionist_TransCode]...';
...
GO
PRINT N'Creating [dbo].[DF_tblTranscriptionist_Status]...';


GO
ALTER TABLE [dbo].[tblTranscriptionist]
    ADD CONSTRAINT [DF_tblTranscriptionist_Status] DEFAULT ('Active') FOR [Status];
