...
SELECT     dbo.tblCase.casenbr, dbo.tblCase.claimnbr, dbo.tblExaminee.addr1 AS examineeaddr1, dbo.tblExaminee.addr2 AS examineeaddr2, 
                      ...
                      ISNULL(dbo.tblUser.lastname, '') + CASE WHEN ISNULL(tblUser.LastName, '') = '' OR
                      ISNULL(tblUser.FirstName, '') = '' THEN '' ELSE ', ' END + ISNULL(dbo.tblUser.firstname, '') AS scheduler, dbo.tblCase.marketercode AS marketer, 
                      dbo.tblCase.dateadded AS datecalledin, dbo.tblCase.dateofinjury AS DOI, dbo.tblCase.allegation, dbo.tblCase.notes, dbo.tblCase.casetype, 
                      ...
                      dbo.tblCase.CertMailNbr, dbo.tblCase.HearingDate, dbo.tblCase.DoctorName, dbo.tblCase.DefParaLegal, dbo.tblLocation.state AS doctorstate, 
                      dbo.tblClient.state AS clientstate, dbo.tblDoctor.state AS doctorcorrespstate, tblCCAddress_1.state AS dattorneystate, tblCCAddress_2.state AS pattorneystate, 
                      dbo.tblCase.prevappt, dbo.tblCase.mastersubcase, dbo.tblCase.mastercasenbr, dbo.tblLocation.city AS doctorcity, dbo.tblLocation.zip AS doctorzip, 
                      dbo.tblClient.city AS clientcity, dbo.tblClient.zip AS clientzip, dbo.tblExaminee.policynumber, tblCCAddress_2.city AS pattorneycity, 
                      tblCCAddress_2.zip AS pattorneyzip, dbo.tblDoctorSchedule.duration AS ApptDuration, dbo.tblDoctor.companyname AS PracticeName, 
                      dbo.tblCase.AssessmentToAddress, dbo.tblCase.OCF25Date, dbo.tblCase.AssessingFacility, dbo.tblCase.DateForminDispute, 
                      dbo.tblExaminee.EmployerContactLastName, dbo.tblExaminee.EmployerContactFirstName, dbo.tblDoctor.NPINbr AS DoctorNPINbr, dbo.tblCase.PublishOnWeb, 
                      dbo.tblProviderType.description AS DoctorProviderType, dbo.tblDoctor.ProvTypeCode, dbo.tblCase.Jurisdiction AS JurisdictionCode, dbo.tblCase.LegalEvent, 
                      dbo.tblCase.PILegalEvent, dbo.tblCase.Transcode, dbo.tblTranscription.transcompany, dbo.tblCase.DateReceived, dbo.tblCase.usddate3 AS caseusddate3, 
                      dbo.tblCase.usddate4 AS caseusddate4, dbo.tblCase.UsdBit1 AS caseusdboolean1, dbo.tblCase.UsdBit2 AS caseusdboolean2, 
                      dbo.tblCase.usddate5 AS caseusddate5, dbo.tblDoctor.usddate3 AS doctorusddate3, dbo.tblDoctor.usddate4 AS doctorusddate4, 
                      dbo.tblDoctor.usdvarchar3 AS doctorusdvarchar3, dbo.tblDoctor.usddate5 AS doctorusddate5, dbo.tblDoctor.usddate6 AS doctorusddate6, 
                      dbo.tblDoctor.usddate7 AS doctorusddate7, dbo.tblCase.ClaimNbrExt, dbo.tblCase.sreqspecialty AS RequestedSpecialty, dbo.tblQueues.statusdesc, 
                      ...
                      dbo.tblLocation.ExtName AS LocationExtName, dbo.tblVenue.County AS Venue, dbo.tblOffice.description AS office, dbo.tblOffice.usdvarchar1 AS OfficeUSDVarChar1, 
                      dbo.tblOffice.usdvarchar2 AS OfficeUSDVarChar2, dbo.tblCase.TransportationRequired, dbo.tblCase.InterpreterRequired, dbo.tblLanguage.Description AS LANGUAGE, 
                      dbo.tblCase.ForecastDate, dbo.tblCase.EWReferralType, dbo.tblCase.EWReferralEWFacilityID, dbo.tblEWFacilityLocal.DoctorCode AS EWFacilityDoctorCode, 
                      dbo.tblDoctor.PrintOnCheckAs
FROM         dbo.tblCase INNER JOIN
                      dbo.tblExaminee ON dbo.tblExaminee.chartnbr = dbo.tblCase.chartnbr INNER JOIN
                      ...
                      dbo.tblCCAddress AS tblCCAddress_2 ON dbo.tblCase.plaintiffattorneycode = tblCCAddress_2.cccode LEFT OUTER JOIN
                      dbo.tblCCAddress AS tblCCAddress_3 ON tblCCAddress_3.cccode = dbo.tblCase.DefParaLegal LEFT OUTER JOIN
                      dbo.tblLanguage ON dbo.tblLanguage.LanguageID = dbo.tblCase.LanguageID LEFT OUTER JOIN
                      dbo.tblEWFacilityLocal ON dbo.tblCase.EWReferralEWFacilityID = dbo.tblEWFacilityLocal.EWFacilityID
GO
...
ALTER VIEW [dbo].[vwDocumentAccting]
AS
SELECT     dbo.tblCase.casenbr, dbo.tblCase.claimnbr, dbo.tblExaminee.addr1 AS examineeaddr1, dbo.tblExaminee.addr2 AS examineeaddr2, 
                      dbo.tblExaminee.city + ', ' + dbo.tblExaminee.state + '  ' + dbo.tblExaminee.zip AS examineecitystatezip, dbo.tblExaminee.SSN, 
                      dbo.tblClient.firstname + ' ' + dbo.tblClient.lastname AS clientname, dbo.tblCompany.extname AS company, dbo.tblClient.phone1 + ' ' + ISNULL(dbo.tblClient.phone1ext,
                      ...
                      CASE WHEN EWReferralType = 2 THEN dbo.tblCase.doctorlocation ELSE dbo.tblAcctingTrans.doctorlocation END AS doctorLocation, dbo.tblAcctingTrans.documentnbr, 
                      dbo.tblAcctingTrans.type AS documenttype, dbo.tblAcctingTrans.appttime, dbo.tblCase.prevappt, dbo.tblLocation.state, dbo.tblClient.state AS Expr1, 
                      dbo.tblDoctor.state AS Expr2, tblCCAddress_1.state AS Expr3, tblCCAddress_2.state AS Expr4, dbo.tblLocation.city AS doctorcity, dbo.tblLocation.zip AS doctorzip, 
                      dbo.tblClient.city AS clientcity, dbo.tblClient.zip AS clientzip, dbo.tblExaminee.policynumber, tblCCAddress_2.city AS pattorneycity, 
                      tblCCAddress_2.zip AS pattorneyzip, dbo.tblCase.mastercasenbr, dbo.tblDoctorSchedule.duration AS ApptDuration, dbo.tblDoctor.companyname AS PracticeName, 
                      dbo.tblCase.AssessmentToAddress, dbo.tblCase.OCF25Date, dbo.tblCase.AssessingFacility, dbo.tblCase.DateForminDispute, 
                      dbo.tblExaminee.EmployerContactFirstName, dbo.tblExaminee.EmployerContactLastName, dbo.tblDoctor.NPINbr AS DoctorNPINbr, 
                      dbo.tblProviderType.description AS DoctorProviderType, dbo.tblDoctor.ProvTypeCode, dbo.tblCase.DateReceived, dbo.tblCase.usddate3 AS caseusddate3, 
                      dbo.tblCase.usddate4 AS caseusddate4, dbo.tblCase.usddate5 AS caseusddate5, dbo.tblCase.UsdBit1 AS caseusdboolean1, 
                      ...
                      dbo.tblCase.ForecastDate, dbo.tblDoctor.PrintOnCheckAs
FROM         dbo.tblCase INNER JOIN
                      dbo.tblExaminee ON dbo.tblExaminee.chartnbr = dbo.tblCase.chartnbr INNER JOIN
                      dbo.tblClient ON dbo.tblCase.clientcode = dbo.tblClient.clientcode INNER JOIN
                      dbo.tblCompany ON dbo.tblClient.companycode = dbo.tblCompany.companycode INNER JOIN
                      ...
                      dbo.tblDoctorSchedule ON dbo.tblCase.schedcode = dbo.tblDoctorSchedule.schedcode LEFT OUTER JOIN
                      dbo.tblDoctor ON 
                      CASE WHEN EWReferralType = 2 THEN dbo.tblCase.doctorcode ELSE dbo.tblAcctingTrans.DrOpCode END = dbo.tblDoctor.doctorcode LEFT OUTER JOIN
                      dbo.tblLocation ON 
                      CASE WHEN EWReferralType = 2 THEN dbo.tblCase.doctorlocation ELSE dbo.tblAcctingTrans.doctorlocation END = dbo.tblLocation.locationcode LEFT OUTER JOIN
                      dbo.tblDoctorLocation ON dbo.tblCase.doctorlocation = dbo.tblDoctorLocation.locationcode AND 
                      dbo.tblCase.doctorcode = dbo.tblDoctorLocation.doctorcode LEFT OUTER JOIN
                      dbo.tblSpecialty ON dbo.tblCase.doctorspecialty = dbo.tblSpecialty.specialtycode LEFT OUTER JOIN
                      dbo.tblProviderType ON dbo.tblDoctor.ProvTypeCode = dbo.tblProviderType.ProvTypeCode LEFT OUTER JOIN
...
INSERT INTO [tbllanguage] ([Description])
 select 'Cambodian'
 where not exists (select description from tblLanguage where description='Cambodian')
GO
...
---------------------------------------------------------------------
--New fields for Migrating Claim changes
---------------------------------------------------------------------

ALTER TABLE [tblCase]
  ADD [GenerateDocumentsClient] BIT
GO

ALTER TABLE [tblCase]
  ADD [GenerateDocumentsDoctor] BIT
GO

ALTER TABLE [tblCase]
  ADD [GenerateDocumentsExaminee] BIT
GO

ALTER TABLE [tblCase]
  ADD [DeliverFinalReportClient] BIT
GO

ALTER TABLE [tblCase]
  ADD [DeliverFinalInvoiceClient] BIT
GO


ALTER TABLE [tblEWFacility]
  ADD [MigratingClaimNotifyEmail] VARCHAR(140)
GO
...
--------------------------------------------------------------------------
--Add a new field in EWFacility to determine the branding of the facility
--------------------------------------------------------------------------
...
ALTER TABLE [tblEWFacility]
  ADD [ProductLine] INTEGER
GO

--------------------------------------------------------------------------
--Changed Brand to ReferralGroup and drop ProductLine
--------------------------------------------------------------------------
...
EXEC sp_rename '[tblEWFacility].[Brand]', 'ReferralGroup', 'COLUMN'
GO


UPDATE tblControl SET DBVersion='1.61'
GO
