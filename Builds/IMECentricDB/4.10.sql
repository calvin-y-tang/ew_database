...
ALTER TABLE [dbo].[tblControl]
    ADD [DirDicomExtractor] VARCHAR (70) NULL;
...
GO
PRINT N'Creating [dbo].[tblFSDetailCondition].[IX_tblFSDetailCondition_Includes]...';


GO
CREATE NONCLUSTERED INDEX [IX_tblFSDetailCondition_Includes]
    ON [dbo].[tblFSDetailCondition]([FSDetailID] ASC, [ConditionTable] ASC)
    INCLUDE([ConditionKey]) WITH (FILLFACTOR = 100);
