...
--Fix: Non-Appt Based Cases do not show doctor information on New Case screen
...
--Allow specific statusCode to be changed to Awaiting Scheduling queue manually
ALTER TABLE tblQueues
 ADD AllowToAwaitingScheduling BIT
GO

UPDATE tblQueues SET AllowToAwaitingScheduling=1 WHERE StatusCode=10
GO


UPDATE tblControl SET DBVersion='1.91'
GO
