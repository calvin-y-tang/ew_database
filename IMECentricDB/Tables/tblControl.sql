CREATE TABLE [dbo].[tblControl] (
    ...
    [DirWebQuickReferralFiles]  VARCHAR (256)     NULL,
    [DirTemplate]               VARCHAR (256)     NULL,
    [DirDirections]             VARCHAR (256)     NULL,
    [SourceDirectory]           VARCHAR (256)     NULL,
    [DirVoicePlayer]            VARCHAR (256)     NULL,
    [DirIMECentricHelper]       VARCHAR (256)     NULL,
    ...
    [Dir7zip]                   VARCHAR (256)     NULL,
    [ApptRequestStatusCode]     INT              NULL,
    [ApptRequestDoctorReasonID] INT              NULL,
    [DirIcon]                   VARCHAR (256)     NULL,
    [DirDicomExtractor]         VARCHAR (256)     NULL,
