...
ALTER TABLE [tblProduct]
  ADD [AllowInvoice] BIT DEFAULT 0 NOT NULL
GO

ALTER TABLE [tblProduct]
  ADD [AllowVoucher] BIT DEFAULT 0 NOT NULL
GO

CREATE TABLE [tblDoctorBusLine] (
  [DoctorCode] INTEGER NOT NULL,
  [EWBusLineID] INTEGER NOT NULL,
  [UserIDAdded] VARCHAR(15),
  [DateAdded] DATETIME,
  CONSTRAINT [PK_tblDoctorBusLine] PRIMARY KEY ([DoctorCode],[EWBusLineID])
)
GO
...
UPDATE tblControl SET DBVersion='2.51'
GO
