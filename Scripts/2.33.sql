ALTER TABLE tblControl
 ADD PortalMasterDBID INT
GO
UPDATE tblControl SET PortalMasterDBID=400
 WHERE 1=(SELECT countryID FROM tblIMEData)
GO
UPDATE tblControl SET PortalMasterDBID=410
 WHERE 2=(SELECT countryID FROM tblIMEData)
GO

insert into tbluserfunction (functioncode, functiondesc)
 select 'WebSupport', 'Web Portal Support Mode Login'
 where not exists (select functionCode from tblUserFunction where functionCode='WebSupport')
...
UPDATE tblControl SET DBVersion='2.33'
GO
