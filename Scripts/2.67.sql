...
GO
IF OBJECT_ID(N'[dbo].[spFrmMainForm]', 'P') IS NOT NULL
DROP PROCEDURE [dbo].[spFrmMainForm]
GO
PRINT N'Dropping [dbo].[vwstatusappt]'
GO
IF OBJECT_ID(N'[dbo].[vwstatusappt]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwstatusappt]
GO
PRINT N'Dropping [dbo].[vwRecordsToInvoice]'
GO
IF OBJECT_ID(N'[dbo].[vwRecordsToInvoice]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwRecordsToInvoice]
GO
...
GO
PRINT N'Dropping [dbo].[vwUserSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwUserSecurity]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwUserSecurity]
GO
PRINT N'Dropping [dbo].[spRptFlashReport]'
GO
IF OBJECT_ID(N'[dbo].[spRptFlashReport]', 'P') IS NOT NULL
DROP PROCEDURE [dbo].[spRptFlashReport]
GO
PRINT N'Dropping [dbo].[vwDocumentAccting]'
GO
IF OBJECT_ID(N'[dbo].[vwDocumentAccting]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwDocumentAccting]
GO
PRINT N'Dropping [dbo].[vwPDFInvDetData]'
GO
IF OBJECT_ID(N'[dbo].[vwPDFInvDetData]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwPDFInvDetData]
GO
PRINT N'Dropping [dbo].[vwPDFInvData]'
GO
IF OBJECT_ID(N'[dbo].[vwPDFInvData]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwPDFInvData]
GO
PRINT N'Dropping [dbo].[vwExportSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwExportSummaryWithSecurity]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwExportSummaryWithSecurity]
GO
PRINT N'Dropping [dbo].[vwAcctingSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwAcctingSummaryWithSecurity]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwAcctingSummaryWithSecurity]
GO
PRINT N'Dropping [dbo].[vwEDIExportSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwEDIExportSummaryWithSecurity]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwEDIExportSummaryWithSecurity]
GO
PRINT N'Dropping [dbo].[vwCaseSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwCaseSummaryWithSecurity]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwCaseSummaryWithSecurity]
GO
PRINT N'Dropping [dbo].[vwRegister]'
GO
IF OBJECT_ID(N'[dbo].[vwRegister]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwRegister]
GO
PRINT N'Dropping [dbo].[vwRegisterTotal]'
GO
IF OBJECT_ID(N'[dbo].[vwRegisterTotal]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwRegisterTotal]
GO
PRINT N'Dropping [dbo].[vwLibertyExport]'
GO
IF OBJECT_ID(N'[dbo].[vwLibertyExport]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwLibertyExport]
GO
...
GO
PRINT N'Dropping [dbo].[vwCaseTrans]'
GO
IF OBJECT_ID(N'[dbo].[vwCaseTrans]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwCaseTrans]
GO
...
GO
PRINT N'Dropping [dbo].[vw_EDIFileAttachments]'
GO
IF OBJECT_ID(N'[dbo].[vw_EDIFileAttachments]', 'V') IS NOT NULL
DROP VIEW [dbo].[vw_EDIFileAttachments]
GO
PRINT N'Dropping [dbo].[vwcasemonitordetail]'
GO
IF OBJECT_ID(N'[dbo].[vwcasemonitordetail]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwcasemonitordetail]
GO
PRINT N'Dropping [dbo].[vwInvoiceAttachmentGuidance]'
GO
IF OBJECT_ID(N'[dbo].[vwInvoiceAttachmentGuidance]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwInvoiceAttachmentGuidance]
GO
PRINT N'Dropping [dbo].[vwAcctRegisterTax]'
GO
IF OBJECT_ID(N'[dbo].[vwAcctRegisterTax]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwAcctRegisterTax]
GO
PRINT N'Dropping [dbo].[vwAcctDocuments]'
GO
IF OBJECT_ID(N'[dbo].[vwAcctDocuments]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwAcctDocuments]
GO
PRINT N'Dropping [dbo].[vwStatusNew]'
GO
IF OBJECT_ID(N'[dbo].[vwStatusNew]', 'V') IS NOT NULL
DROP VIEW [dbo].[vwStatusNew]
GO
PRINT N'Creating [dbo].[vwPDFInvDetData]'
GO
IF OBJECT_ID(N'[dbo].[vwPDFInvDetData]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwPDFInvDetData
AS
	SELECT	
...
'
GO
PRINT N'Creating [dbo].[vwDocumentAccting]'
GO
IF OBJECT_ID(N'[dbo].[vwDocumentAccting]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwDocumentAccting
AS
...
'
GO
PRINT N'Creating [dbo].[vwAcctDocuments]'
GO
IF OBJECT_ID(N'[dbo].[vwAcctDocuments]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwAcctDocuments
AS
    SELECT  tblCase.CaseNbr ,
...
'
GO
PRINT N'Creating [dbo].[vwAcctRegisterTax]'
GO
IF OBJECT_ID(N'[dbo].[vwAcctRegisterTax]', 'V') IS NULL
EXEC sp_executesql N'CREATE  VIEW vwAcctRegisterTax
AS
    SELECT  x.taxcode ,
            x.HeaderID ,
            x.DocumentNbr ,
...
'
GO
PRINT N'Creating [dbo].[vwInvoiceAttachmentGuidance]'
GO
IF OBJECT_ID(N'[dbo].[vwInvoiceAttachmentGuidance]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW [dbo].[vwInvoiceAttachmentGuidance]
AS
...
'
GO
PRINT N'Creating [dbo].[vwRecordsToInvoice]'
GO
IF OBJECT_ID(N'[dbo].[vwRecordsToInvoice]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwRecordsToInvoice
AS
...
'
GO
PRINT N'Creating [dbo].[vwcasemonitordetail]'
GO
IF OBJECT_ID(N'[dbo].[vwcasemonitordetail]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwCaseMonitorDetail
...
'
GO
PRINT N'Creating [dbo].[vwLibertyExport]'
GO
IF OBJECT_ID(N'[dbo].[vwLibertyExport]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwLibertyExport
AS
...
'
GO
PRINT N'Creating [dbo].[vwCaseTrans]'
GO
IF OBJECT_ID(N'[dbo].[vwCaseTrans]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwCaseTrans
AS
...
'
GO
PRINT N'Creating [dbo].[vw_EDIFileAttachments]'
GO
IF OBJECT_ID(N'[dbo].[vw_EDIFileAttachments]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vw_EDIFileAttachments
AS
...
'
GO
PRINT N'Creating [dbo].[vwUserSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwUserSecurity]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwUserSecurity
AS
    SELECT  DISTINCT
...
'
GO
PRINT N'Creating [dbo].[vwStatusAppt]'
GO
IF OBJECT_ID(N'[dbo].[vwStatusAppt]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwStatusAppt
AS
    SELECT  tblCase.CaseNbr ,
            tblExaminee.LastName + '', '' + tblExaminee.FirstName AS examineename ,
            tblClient.LastName + '', '' + tblClient.FirstName AS clientname ,
...
'
GO
PRINT N'Creating [dbo].[vwAcctingSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwAcctingSummaryWithSecurity]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwAcctingSummaryWithSecurity
AS
    Select 
            AT.SeqNO ,
            AT.StatusCode ,
...
'
GO
PRINT N'Creating [dbo].[vwCaseSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwCaseSummaryWithSecurity]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwCaseSummaryWithSecurity
AS
    SELECT  tblCase.CaseNbr ,
            tblExaminee.LastName + '', '' + tblExaminee.FirstName AS ExamineeName ,
            tblClient.LastName + '', '' + tblClient.FirstName AS ClientName ,
...
'
GO
PRINT N'Creating [dbo].[vwEDIExportSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwEDIExportSummaryWithSecurity]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwEDIExportSummaryWithSecurity
AS
    SELECT  tblCase.CaseNbr ,
			tblAcctingTrans.SeqNO ,
			tblAcctHeader.HeaderID ,
...
EXEC sp_executesql N'CREATE VIEW vwExportSummary
AS
    SELECT  tblCase.casenbr ,
            TblAcctHeader.documenttype ,
            TblAcctHeader.documentnbr ,
...
'
GO
PRINT N'Creating [dbo].[vwExportSummaryWithSecurity]'
GO
IF OBJECT_ID(N'[dbo].[vwExportSummaryWithSecurity]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwExportSummaryWithSecurity
AS
    SELECT  tblCase.CaseNbr ,
			tblAcctHeader.HeaderID ,
            tblAcctHeader.DocumentType ,
...
'
GO
PRINT N'Creating [dbo].[vwStatusNew]'
GO
IF OBJECT_ID(N'[dbo].[vwStatusNew]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwStatusNew
AS
    SELECT DISTINCT
            tblCase.casenbr
           ,tblExaminee.lastname + '', '' + tblExaminee.firstname AS examineename
...
'
GO
PRINT N'Creating [dbo].[vwRegisterTotal]'
GO
IF OBJECT_ID(N'[dbo].[vwRegisterTotal]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwRegisterTotal
AS
    SELECT  Casenbr ,
            HeaderID ,
            documenttype ,
...
'
GO
PRINT N'Creating [dbo].[vwRegister]'
GO
IF OBJECT_ID(N'[dbo].[vwRegister]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwRegister
AS
...
'
GO
PRINT N'Creating [dbo].[spRptFlashReport]'
GO
IF OBJECT_ID(N'[dbo].[spRptFlashReport]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROCEDURE [dbo].[spRptFlashReport]
@Month int,
@Year int,
@sReport varchar (20) ,
@EWFacilityID int
...
'
GO
PRINT N'Creating [dbo].[vwPDFInvData]'
GO
IF OBJECT_ID(N'[dbo].[vwPDFInvData]', 'V') IS NULL
EXEC sp_executesql N'CREATE VIEW vwPDFInvData
AS
...
'
GO
PRINT N'Creating [dbo].[spFrmMainForm]'
GO
IF OBJECT_ID(N'[dbo].[spFrmMainForm]', 'P') IS NULL
EXEC sp_executesql N'CREATE PROC dbo.spFrmMainForm
    @sForm varchar(50),
    @iOfficeCode int,
...
UPDATE tblControl SET DBVersion='2.67'
GO
