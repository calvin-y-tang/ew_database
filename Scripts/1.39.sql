----------------------------------------------------
--Change vwDocumentAccting to use tblCase.DoctorCode instead of tblAcctingTrans.DrOpCode
--when EW Referral Type is Outgoing
----------------------------------------------------
...
--------------------------------------------------------------------------------------------
--Add default duration and exam rooms fields for ScheduleViewer
--------------------------------------------------------------------------------------------

ALTER TABLE [tblIMEData]
  ADD [ApptDuration] INTEGER
GO


ALTER TABLE [tblLocation]
  ADD [ExamRooms] INTEGER
GO
...
ALTER TABLE [dbo].[tblNonWorkDays] ADD
	[Description] [varchar] (25) NULL
GO


UPDATE tblControl SET DBVersion='1.39'
GO