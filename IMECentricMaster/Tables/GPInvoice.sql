CREATE TABLE [dbo].[GPInvoice] (
    ...
    [DocumentTaxCode4]   VARCHAR (10)    NULL,
    [DocumentTaxCode5]   VARCHAR (10)    NULL,
    [DocumentTaxCode6]   VARCHAR (10)    NULL,
    [DocumentTaxCode7]   VARCHAR (10)    NULL,
    [DocumentTaxCode8]   VARCHAR (10)    NULL,
